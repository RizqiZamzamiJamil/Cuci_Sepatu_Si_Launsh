                ...
                <div class="col-8">
                    ...
                    <form action="/pemesanan/insertPesanan">
                        ...
                        <div class="row" style="margin-top: 10px;" data-aos="fade-up" data-aos-delay="1100">
                            ...
                            <div class="col">
                                <label data-aos="fade-up" data-aos-delay="950" for="jenisbayar" class="form-label">Kategori Sepatu</label>
...
<div class="pop-up">
    ...
    <div id="detail-modal" class="modal">
        <div class="modal-content">
            ...
            <button onclick="simpanSepatu()" id="tombol-bayar" type="button">
                Bayar Sekarang
            </button>
        </div>
    </div>
